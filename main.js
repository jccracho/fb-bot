...
let msgs = {};
let vips = ['100056442565207', '100063176375996', '100054067209062'];
let cd = {};
...
if (input.startsWith(">help")) {
                        ...
                        api.getUserID("Zodiac.lang.malakas", (err,data) =>{
                                api.sendMessage({
                                    body: "📄Zodiac Bot Information📄\n\n🛡Created by:  " + '@Earl Shine'+ "\n📜Description: Zodiac Bot is a Facebook messenger chat bot made using NodeJS, Axios and the Unofficial Facebook Chat API.\n\n\n🤝Thanks to:\nRyann Kim Sesgundo\nJohn Paul Caigas\nJovanny De Leon\nJohn Jeremy Antiguo\nJohn Roy Calimlim\nSalvador" + "\n\n\n",
                                    mentions: [{
                                        tag: '@Earl Shine',
                                        id: data[0].userID,
                                    }]
